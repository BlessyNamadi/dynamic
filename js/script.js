...
*/
    ...
    var body=document.querySelector("#root");
       ...
       // var name=document.createElement("h2");
        ...
        name1.textContent="N.Blessy";
        console.log(name1);
        card1.appendChild(name1);
         // careate email
        var email=document.createElement("h4");
        email.textContent="blessynamadi125@gmail.com";
        card1.appendChild(email);

         // mobile number also
        var mobile=document.createElement("h4");
        mobile.textContent="9398959167";
        ...
        co1.textContent="To obtain a position in learning and challenging environment that will allow me to utilize my skills";
        div.appendChild(co1);
        ...
        s1.textContent="C Programming Basics";
        div.appendChild(s1);

        var s2=document.createElement("p","pre");
        s2.textContent="Python Basics";
        div.appendChild(s2);

        var s3=document.createElement("p","pre");
        s3.textContent="HTML Basics";
        div.appendChild(s3);

        var s4=document.createElement("p","pre");
        s4.textContent="CSS Basics";
        div.appendChild(s4);
        ...
        p1.textContent="Singing";
        div.appendChild(p1);

        var p2=document.createElement("p","pre");
        p2.textContent="Listening Music";
        div.appendChild(p2);

        var p3=document.createElement("p","pre");
        p3.textContent="learning New Things";
        div.appendChild(p3);
        ...
        pp3.textContent="DOB          : 11/03/1999";
        div.appendChild(pp3);
